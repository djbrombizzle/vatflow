...
> arrival is headed for and hand it to the right one — the ramp and entry spot on each
> inbound tag, and a Ground / Ramp Entry list carrying ramp, frequency, spot and gate.
>
