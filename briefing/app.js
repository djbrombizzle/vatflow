...
(function () {
  ...
  function renderArrival(M) {
    ...
    cards.appendChild(card('N', 'NOTAMs', 'destination · alternate · enroute', nbody, true));
    ...
    abody.push(notesField('arr.automation', 'Approach type · automation plan · missed approach'));
    cards.appendChild(card('A', 'Arrival / Approach / Automation', 'STAR · approach · automation', abody));
    ...
    tbody.push(notesField('arr.taxi', 'Expected taxi route · hot spots · terrain'));
    cards.appendChild(card('T', 'Transition / Terrain / Taxi', 'transition level · terrain · taxi in', tbody));
    ...
    sbody.push(notesField('arr.s', 'Company pages · specific information'));
